...
<!--                    <a class="active" href="https://pv-foto.ru/%d0%b3%d0%b0%d0%bb%d0%b5%d1%80%d0%b5%d1%8f/">Смотреть-->
<!--                        фото</a>-->
...
<!--    </header>-->
    ...
    <main class="main-leaders">
                ...
                if (is_user_logged_in()) {
                    ...
                    <div class="">
                        <div class="join-pop" data-id="<?php echo $post_id; ?>">
                            <button class="d-none" type="submit" name="like" value=""><i class="fas fa-heart"></i>
                            </button>
        ...
        <div class="navi-container flex-end">
            <div class="navigation-line step-5 line-5-gallery">
    ...
    <div class="choose-leader">
        ...
        <div class="choose-leader__select">
            ...
            <form class="gal-options" action="#" method="get">
                <input type="radio" name="direction" value="up" id="up" <?php if (!isset($sort_direction)) {
                    echo "checked";
                }
                if (isset($sort_direction) && $sort_direction == 'ASC') {
                    echo "checked";
                } ?> >
                <div class="">
                ...
                <input type="radio" name="direction" value="down"
                       id="down" <?php if (isset($sort_direction) && $sort_direction == 'DESC') {
                    echo "checked";
                } ?> >
                <div class="">
                ...
                <select class="select-option" name="options">
                    <option value="date"<?php if (!isset($sort_by)) {
                        echo " selected";
                    }
                    ...
                    <option value="like"<?php if (isset($sort_by) && $sort_by == 'like') {
                        echo " selected";
                    } ?> >по Лайкам
                    </option>
                    <option value="random" <?php if (isset($sort_by) && $sort_by == 'random') {
                        echo " selected";
                    } ?> >Случайная
                    </option>
                </select>
