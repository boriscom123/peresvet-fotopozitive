...
//                 if (document.documentElement.clientWidth > 1100) {
//                     lineBox[0].children[i].elementMaxWidth = 1100;
//                 } else {
//                     lineBox[0].children[i].elementMaxWidth = document.documentElement.clientWidth - 20;
//                 }
//                 if (lineBox[0].children[i].elementWidth < 0) {
//                     lineBox[0].children[i].style.width = 0 + 'px';
//                 } else if (lineBox[0].children[i].elementWidth < 100) {
//                     lineBox[0].children[i].style.width = (lineBox[0].children[i].elementMaxWidth / 100 * Math.floor(lineBox[0].children[i].elementWidth)) + 'px';
//                 } else {
//                     lineBox[0].children[i].style.width = lineBox[0].children[i].elementMaxWidth + 'px';
//                 }
//             } else {
//                 // вертикальная линия
//                 lineBox[0].children[i].elementStart = (lineBox[0].children[i].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight / 2) + 50;
...
//                     if (lineBox[0].children[i].elementHeight < 0) {
//                         lineBox[0].children[i].style.height = 0 + 'px';
//                     } else if (lineBox[0].children[i].elementHeight < 400) {
//                         lineBox[0].children[i].style.height = (lineBox[0].children[i].elementHeight * lineBox[0].children[i].step) + 'px';
//                     } else {
//                         lineBox[0].children[i].style.height = lineBox[0].children[i].elementMaxHeight + 'px';
//                     }
//                 } else {
...
//                     if (lineBox[0].children[i].elementHeight < 0) {
//                         lineBox[0].children[i].style.height = 0 + 'px';
//                     } else if (lineBox[0].children[i].elementHeight < lineBox[0].children[i].elementMaxHeight) {
//                         lineBox[0].children[i].style.height = (lineBox[0].children[i].elementHeight * 1.5) + 'px';
//                     } else {
//                         lineBox[0].children[i].style.height = lineBox[0].children[i].elementMaxHeight + 'px';
//                     }
//                 }
...
//     prepareLines(this)
// }, false); // активность при изменении размера страницы
//addEventListener("scroll",  function(){prepareLines(this)}, false); // активность при при прокрутке страницы
