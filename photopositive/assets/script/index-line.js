...
function showCoord(){
  ...
  var el4Start = ((lineStep4[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  var el10Start = ((lineStep10[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  var el12Start = ((lineStep12[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  var el14Start = ((lineStep14[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  var el16Start = ((lineStep16[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  var el18Start = ((lineStep18[0].getBoundingClientRect().top + window.pageYOffset) - (document.documentElement.clientHeight/2) + 50); // Горизонтпльный элемент
  ...
  if(document.documentElement.clientWidth > 1100) { var el9MaxWidth = 1100; } else { var el9MaxWidth = document.documentElement.clientWidth - 20; }
  var el10MaxHeight = lineStep11[0].getBoundingClientRect().top - lineStep10[0].getBoundingClientRect().top + 7;
  if(document.documentElement.clientWidth > 1100) { var el11MaxWidth = 1100; } else { var el11MaxWidth = document.documentElement.clientWidth - 20; }
  var el12MaxHeight = lineStep13[0].getBoundingClientRect().top - lineStep12[0].getBoundingClientRect().top + 7;
  if(document.documentElement.clientWidth > 1100) { var el13MaxWidth = 1100; } else { var el13MaxWidth = document.documentElement.clientWidth - 20; }
  var el14MaxHeight = lineStep15[0].getBoundingClientRect().top - lineStep14[0].getBoundingClientRect().top + 7;
  if(document.documentElement.clientWidth > 1100) { var el15MaxWidth = 1100; } else { var el15MaxWidth = document.documentElement.clientWidth - 20; }
  var el16MaxHeight = lineStep17[0].getBoundingClientRect().top - lineStep16[0].getBoundingClientRect().top + 7;
  if(document.documentElement.clientWidth > 1100) { var el17MaxWidth = 1100; } else { var el17MaxWidth = document.documentElement.clientWidth - 20; }
  ...
  if(window.pageYOffset == 0) {
    ...
    lineStep17[0].style.width = elMin + 'px';
    lineStep18[0].style.height = elMin + 'px';
  } else if (window.pageYOffset > el8Start && window.pageYOffset <= el9Start) {
    // Элемент 8
    var step = el8MaxHeight / (el9Start - el8Start);
    var el8Height = ((window.pageYOffset - el8Start) * step);
    if(el8Height > el8MaxHeight) { el8Height = el8MaxHeight; }
    ...
    if(el9Width > el9MaxWidth) { el9Width = el9MaxWidth; }
      else { el9Width = el9Width; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el10Height > el10MaxHeight) { el10Height = el10MaxHeight; }
      else { el10Height = el10Height; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el11Width > el11MaxWidth) { el11Width = el11MaxWidth; }
      else { el11Width = el11Width; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el12Height > el12MaxHeight) { el12Height = el12MaxHeight; }
      else { el12Height = el12Height; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el13Width > el13MaxWidth) { el13Width = el13MaxWidth; }
      else { el13Width = el13Width; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el14Height > el14MaxHeight) { el14Height = el14MaxHeight; }
      else { el14Height = el14Height; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el15Width > el15MaxWidth) { el15Width = el15MaxWidth; }
      else { el15Width = el15Width; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el16Height > el16MaxHeight) { el16Height = el16MaxHeight; }
      else { el16Height = el16Height; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el17Width > el17MaxWidth) { el17Width = el17MaxWidth; }
      else { el17Width = el17Width; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
    ...
    if(el18Height > el18MaxHeight) { el18Height = el18MaxHeight; }
      else { el18Height = el18Height; }
    lineStep2[0].style.height = el2MaxHeight + 'px';
    lineStep3[0].style.width = el3MaxWidth + 'px';
    lineStep4[0].style.height = el4MaxHeight + 'px';
    lineStep5[0].style.width = el5MaxWidth + 'px';
...
var lineEnd = document.getElementsByClassName('forms'); // Блок с формами - конец линий
