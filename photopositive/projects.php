...
//                        ?>
    ...
    <div class="join">
        <div class="join__content">
            <?php if (is_user_logged_in()) : ?>
                <!--                <form action='https://pv-foto.ru/%d0%bb%d0%b8%d1%87%d0%bd%d1%8b%d0%b9-%d0%ba%d0%b0%d0%b1%d0%b8%d0%bd%d0%b5%d1%82/'-->
                <!--                      method='post' id='go-to-add-foto'></form>-->
                <!--                <button type='submit' name='go-to-add-foto' form='go-to-add-foto' value='3'>Добавить работу</button>-->
                <a href="/личный-кабинет/">Добавить работу</a>
            <?php else : ?>
                <div class='button show-join-pop'>Принять участие</div>
            <?php endif; ?>
        </div>
    </div>
